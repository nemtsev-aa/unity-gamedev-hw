...
namespace BehaviorTree.Brain {
    ...
    [AddComponentMenu("")]
    [MBTNode("Main Companents/" + nameof(FarmingSequence))]
    public class FarmingSequence : Composite {
        ...
        public override NodeResult Execute() {
            ...
            if (_botBrainData.NearestResourceSource.CurrentValue == null)
            ...
            if (_farmSucces == false) {

                FarmNode.OnEnter();
                _farmSucces = NodeExecute(FarmNode, out var farmActionResult);
            ...
            if (_moveSucces == _farmSucces == _waitSucces == true) {
        ...
        private void ResetSequence() {
            ...
            _botBrainData.SetResourceSource(null);
        }
    }
}
